        ...
        <div class="row">
          ...
          <div class="personal-info col-sm-6">
            ...
            <fieldset>
              ...
              <div class="form-group">
                <label for="studentno">Student ID Number</label>
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="course">
                  <option value="BSBA">English</option>
                  <option value="BSOA">Mathematics</option>
                  <option value="BSIT">Phyics</option>
                  <option value="BSCS">Chemistry</option>
                  <option value="BSCE">Biology</option>
                  <option value="BSBA">Geography</option>
                  <option value="BSOA">Economics</option>
                  <option value="BSIT">Accounting</option>
                  <option value="BSCS">Management</option>
                  <option value="BSCE">Finance</option>
              ...
              <div class="form-group">
                <label for="yrlevel">Standered Level</label>

                <select class="form-control" name="yrlevel">
                  <option>1st Standered</option>
                  <option>2nd Standered</option>
                  <option>3rd Standered</option>
                  <option>4th Standered</option>
                  <option>5th Standered</option>
                  <option>6th Standered</option>
                  <option>7th Standered</option>
                  <option>8th Standered</option>
                  <option>9th Standered</option>
                  <option>10th Standered</option>
                  <option>11th Standered</option>
                  <option>12th Standered</option>
                </select>
